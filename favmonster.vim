" Vim color file
" Credits:   David Liang (bmdavll at gmail dot com) - November 28 2008
"
" favmonster.vim - a modified version of wombat256
...
call <SID>X("Normal",		"E6E1DC",	"000000",	"none")
call <SID>X("Cursor",		"",	"91c729",	"none")
call <SID>X("CursorLine",	"",	"333435",	"none")
call <SID>X("CursorColumn",	"",			"2d2d2d",	"")
			"CursorIM
			"Question
			"IncSearch
call <SID>X("Search",		"ffffff",	"91c729",	"")
call <SID>X("MatchParen",	"ecee90",	"857b6f",	"bold")
call <SID>X("SpecialKey",	"6c6c6c",	"2d2d2d",	"none")
call <SID>X("Visual",		"5a647e",	"91c729",	"none")
call <SID>X("LineNr",		"6c6c6c",	"000000",	"none")
...
call <SID>X("Define",		"91c729",	"",			"none")
call <SID>X("String",		"91c729",	"",			"italic")
call <SID>X("Comment",		"6c6c6c",	"",			"italic")
call <SID>X("Identifier",	"d0d0ff",	"",			"none")
call <SID>X("Keyword",		"cc7833",	"",			"none")
call <SID>X("Statement",	"91c729",	"",			"none")
call <SID>X("Function",		"ffc66d",	"",			"none")
call <SID>X("PreProc",		"cc7833",	"",			"none")
call <SID>X("Type",			"da4939",	"",			"none")
call <SID>X("Special",		"ffdead",	"",			"none")
call <SID>X("Todo",			"ffffff",	"91c729",			"italic")
			"Underlined
			"Error
			"Ignore
